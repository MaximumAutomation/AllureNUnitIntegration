...
namespace SeleniumNUnitProject.StepDefinition
{
    ...
    {        
        ...
        //[Given(@"print number ""([^""]*)""")]
        //public void GivenPrintNumber(string p0)
        //{
        //    Serilog.Log.Debug("Numer is:" + p0);
        //}
        //[When(@"entered int (.*)")]
        //public void WhenEnteredIntVar(int p0)
        //{
        //    Serilog.Log.Debug("Numer is:" + p0);
        //}
        ...
        [Given(@"I have (.*) books? in cart")]
        public void GivenIHaveBookInCart(int count)
        {
            Console.WriteLine("Boook count is: "+count);
        }
